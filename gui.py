...
# We'll avoid setting an image like car.jpg (a photo, not icon) as iconphoto
# If logo.png exists, use it; otherwise skip icon
...
# Safe loading for heading image (if desired)
img = None
        ...
        if ratio_and_rotation(min_rect):
            ...
            if isMaxWhite(plate_img):
                ...
                if rect:
                    ...
                    cv2.imshow("Detected Plate Region", clean_plate)
                    cv2.imwrite("debug_cleaned_plate.png", clean_plate)
